...
liblangserver_dir = os.path.dirname(os.path.abspath(__file__))

if os.path.isdir(os.path.join(liblangserver_dir, "packages")):
    print("Packages are inside this directory")
    packages_dir = os.path.join(liblangserver_dir, "packages")
else:
    parent = os.path.dirname(liblangserver_dir)
    
    if os.path.isdir(os.path.join(parent, "liblangserver")):
        print("liblangserver is a peer")
        packages_dir = parent
    else:
...
#            )
    ...
    def copy_extensions_to_source(self):
        ...
        copy_file(
            os.path.join(cwd, "build", "src", "liblangserver.so"),
            os.path.join(package_dir, "liblangserver.so"))
...
ext = Extension("lls.core",
            extra_compile_args=extra_compile_args,
            sources=[
                os.path.join(liblangserver_dir, 'python', "core.pyx"), 
            ],
            language="c++",
            include_dirs=[
                os.path.join(liblangserver_dir, 'python'),
                os.path.join(liblangserver_dir, 'src', 'include'),
                os.path.join(packages_dir, 'debug-mgr', 'src', 'include'),
                os.path.join(packages_dir, 'debug-mgr', 'python'),
                os.path.join(packages_dir, 'libjson-rpc', 'src', 'include'),
                os.path.join(packages_dir, 'libjson-rpc', 'python'),
...
setup(
  ...
  url = "https://github.com/mballance-utils/liblangserver",
  install_requires=[
    'debug-mgr',
    'libjson-rpc'
  ],
